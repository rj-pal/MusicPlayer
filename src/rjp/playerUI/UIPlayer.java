...
//    List<>
    ...
    public UIPlayer(Player myPlayer) {
            ...
            try {
                ...
                if (selection == 1) {
                    ...
                    if (myPlayer.findAlbum(albumName, artistName)) {
                        if (myPlayer.listenAlbum(albumName, artistName)) {
                    ...
                    System.out.println(menu);
                    return;
//                    List<Song> listenAlbum = myPlayer.listenAlbum(albumDetails[0], albumDetails[1]);
//                    if (listenAlbum == null) {
//                        System.out.println("An error occurred. The album could not be played.\n" + menu);
//                    } else
//                        play(albumDetails[0], listenAlbum);
//                    return;
                } else if (selection ==2) {
                    ...
                    System.out.println("Catching the non 1 or 2?");
                }
            } catch (Exception e) {
                System.out.println("Invalid Input. Please select again.");
                System.out.println("Cathing the exception??");
                scanner.nextLine();
            }
        }
    }
...
//        String format = "%-35s%-10s";
        ...
        for (String[] album: myPlayer.myAlbumInfo()) {
