//import rjp.player.Album;
//import rjp.player.Player;
//import rjp.player.Song;
//
//import java.util.*;
//
//public class UIPlayer2 {
//
...
//
//        String format = "%-25s%-10s%-30s%-10s%-50s%s%n";
//
//        System.out.printf(format, "2. Recently Added", "|", "6. Add an Album", "", "", "");
//        System.out.printf(format, "3. Artists", "|", "7. Add a Song", "|", "10. Change " +
//                "the name of your Music Player", "|");
//        System.out.printf(format, "4. Albums", "|", "8. Create a Playlist", "|", "11. Change " +
//                "the name of a Playlist", "|");
//        System.out.printf(format, "5. Playlists", "|", "9. Update a Playlist", "|", "12. Quit", "|");
//    }
//
//    public void menu() {
//        boolean quit = false;
...
//                        break;
//                    } case 6: {
//                        // TODO Make create album a boolean
//                        createAlbum(scanner);
//                        this.myAlbums = myPlayer.myAlbumInfo();
//                        System.out.println(enter);
//                        scanner.nextLine();
...
//                        // TODO make it a boolean method
//                        this.myPlaylists = myPlayer.myPlayListNames(); // update saved list of playlists for displaying.
//                        System.out.println(enter);
//                        scanner.nextLine();
//                        printMenu();
//                        break;
//                    } case 9: { //Method updatePlaylist used to add song after selecting playlist
...
//    }
//
//    private void play(String name, List<Song> tracks) {
...
//            return;
//        }
//        System.out.println("Now Playing: " + myPlayer.getAlbumName(name));
//
...
//        System.out.println("****************************************");
//
//        System.out.println("1- Back\t2- Play From Start\t3- Forward\n" +
//                "4- Play track Again\t0- Stop");
//
...
//
//    /*
//     * There are seven methods used to display Albums, Song (with or without duration), PlayLists, and track numbers.
//     */
...
//            System.out.println();
//        } else {
//            System.out.println("No Tracks. This album is empty");
//        }
//    }
//
...
//        System.out.println("Recently Downloaded Albums for " + playerName + ":\n");
////        List<String[]> albumList = myPlayer.myAlbumInfo();
//        for (int i = myAlbums.size()-1; i >= 0; i--) { //Goes through array list in reverse
//            String[] tempAlbum = myAlbums.get(i);
...
////        List<String> playlists = myPlayer.myPlayListNames();
//        if (myPlaylists.isEmpty()) {
//            System.out.println("There are no available playlists.\n");
//            return;
//        }
//        System.out.println("Playlists for " + playerName +":\n");
//        for (String playlistName: myPlaylists) {
//            System.out.println(playlistName);
//            displayTracksShort(myPlayer.getPlayListSongNames(playlistName)); // getPlayListSongNames used just one time
//            System.out.println();
//        }
//    }
//
...
//                }
//            }
//            System.out.println("The Album " + albumName + " by " + artistName + " was created and " + songNumber +
//                    " were added. Update complete.");
...
//        } else {
//            System.out.println("An error occurred and your playlist was not added to your player. Make sure your " +
//                    "playlist name is original and not duplicated.\n" + menu);
//        }
//    }
//
...
//            displayAlbumsShort();
//
//            System.out.println("Please add a song to your playlist. Choose an album from above.");
//            System.out.print("(Type 'Quit' to return to the main menu or Press 'Enter' to continue): ");
////            String nameOfAlbum = scanner.nextLine().trim();
...
//                String albumName = myPlayer.getAlbumName(nameOfAlbum);
//                String artistName = myPlayer.getArtistName(nameOfAlbum);
...
//    }
//
//    public boolean isInteger(String str) { //modified method found on StackOverflow
//        if (str == null) {
//            return false;
//        }
...
//        System.out.println(myPlayer.addAlbum("Pop Mart Live", "U2"));
////
...
//        System.out.println(myPlayer.addAlbum(u2));
//        System.out.println(myPlayer.addAlbum(u2));
//        System.out.println(myPlayer.addAlbum(u2));
//        System.out.println(myPlayer.addSong("War", "Sunday Bloody Sunday", 7.55));
//        System.out.println(myPlayer.addSong("War", new Song("11 O'clock Tick Tock", 3.45)));
//        System.out.println(myPlayer.addAlbum(new Album("War", "U2")));
//        System.out.println(myPlayer.addAlbum(new Album("War", "U2")));
//        System.out.println(myPlayer.addAlbum(new Album("War", "U2")));
////
//////
...
////        System.out.println(u2.addSong(u2Song));
//        System.out.println(myPlayer.addAlbum(u2));
//        UIPlayer2 player = new UIPlayer2(myPlayer);
////        player.play("War", myPlayer.myAlbums.get(1).getSongs());
//        player.menu();
//    }
//
//
